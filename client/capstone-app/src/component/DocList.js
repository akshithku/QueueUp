          ...
          <div className="Docapp">
            ...
            <div className="SubContainer">
              ...
              <div className="div-list">
                <h1 className="lit" value={name} onChange={(abd)=>setName(abd.target.value)}>{abc.name}</h1>
            ...
            <div className="SubContainer-1">
              <div className="doc-lit">
                <div className="slot-1">
                  ...
                  >
                    <option className="mrng" value="Morning">Morning</option>
              ...
              <Link to="/Pay">
                <button id="btn1" onClick={handleClick}>Book Now</button>
              </Link>
            </div>
          </div>
        );
